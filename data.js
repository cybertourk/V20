...
export const ARCHETYPES = [
    ...
    "Rebel", "Rogue", "Sadist", "Scientist", "Sociopath", "Soldier", 
    "Survivor", "Thrill-Seeker", "Traditionalist", "Trickster", "Visionary"
];

export const ARCHETYPE_RULES = {
    "Architect": "Regain a point of Willpower whenever you establish something of importance or lasting value.",
    "Autocrat": "Regain a point of Willpower when you achieve control over a group or organization involving other individuals.",
    "Bon Vivant": "Regain a point of Willpower whenever you truly enjoy yourself and can fully express your exultation.",
    "Bravo": "Regain a point of Willpower any time you achieve your agenda through brutishness or intimidation.",
    "Capitalist": "Regain a point of Willpower whenever you make a successful “sale” of any commodity (goods, info, favors).",
    "Caregiver": "Regain a point of Willpower whenever you successfully protect or nurture someone else.",
    "Celebrant": "Regain a point of Willpower whenever you pursue your cause or convert another character to the same passion.",
    "Chameleon": "Regain a point of Willpower whenever you fool someone into thinking you’re someone else for your own benefit.",
    "Child": "Regain a point of Willpower whenever you manage to convince someone to help you with no gain to herself, or to nurture you.",
    "Competitor": "Regain one point of Willpower whenever you succeed at a test or challenge (a dramatic situation, not just a roll).",
    "Conformist": "Regain a point of Willpower whenever the group or your supported leader achieves a goal due to your support.",
    "Conniver": "Regain a point of Willpower whenever you trick someone into doing something for you.",
    "Creep Show": "Regain a point of Willpower whenever someone recoils from you in horror or otherwise reacts in fear.",
    "Critic": "Regain a point of Willpower whenever you discover a significant imperfection that has escaped the notice of others.",
    "Curmudgeon": "Regain a point of Willpower whenever someone does something specific and negative, just like you predicted.",
    "Dabbler": "Regain Willpower whenever you find a new enthusiasm and drop your old one completely.",
    "Deviant": "Regain a point of Willpower any time you are able to flout social mores without retribution.",
    "Director": "Regain a point of Willpower when you influence or aid a group or influential individual in the completion of a difficult task.",
    "Enigma": "Regain a point of Willpower whenever someone is completely perplexed or baffled by one of your actions that later turns out fruitful.",
    "Eye of the Storm": "Regain a point of Willpower whenever a ruckus, riot, or less violent but equally chaotic phenomenon occurs around you.",
    "Fanatic": "Regain a point of Willpower whenever you accomplish some task that directly relates to your cause.",
    "Gallant": "Regain a Willpower point whenever you successfully impress another person.",
    "Guru": "Regain a point of Willpower whenever someone seeks out your help in spiritual matters and your guidance moves them to enlightened action.",
    "Idealist": "Regain a point of Willpower any time an action in pursuit of your ideals furthers your goals and brings your ideal closer to fruition.",
    "Judge": "Regain a point of Willpower whenever you correctly solve a problem by considering the evidence presented.",
    "Loner": "Regain a point of Willpower when you accomplish something by yourself, yet which still benefits the coterie in some way.",
    "Martyr": "Regain a point of Willpower when you suffer some amount of damage or loss of a definable resource for your ideals or another’s gain.",
    "Masochist": "Regain one point of Willpower when your own suffering leads to some tangible gain for you.",
    "Monster": "Regain Willpower whenever you indulge a specific atrocity associated with your purpose.",
    "Pedagogue": "Regain one point of Willpower whenever you see or learn of someone who has benefited from the wisdom you shared with them.",
    "Penitent": "Regain a point of Willpower whenever you feel that you have achieved absolution for a given grievance.",
    "Perfectionist": "Regain a point of Willpower whenever you accomplish your goal without any demonstrable flaw or impediment.",
    "Rebel": "Regain a point of Willpower whenever your actions adversely affect your chosen opposition.",
    "Rogue": "Regain a point of Willpower when your self-centered disposition leads you to profit, materially or otherwise.",
    "Sadist": "Regain a point of Willpower whenever you inflict pain upon someone for no reason other than your own pleasure.",
    "Scientist": "Regain Willpower any time a logical, systematic approach to a problem helps you solve it.",
    "Sociopath": "Regain Willpower whenever you are the greatest contributor to a body count after everything has settled down.",
    "Soldier": "Regain a point of Willpower when you achieve your orders’ objectives.",
    "Survivor": "Regain one point of Willpower whenever you survive a threatening situation through tenacity.",
    "Thrill-Seeker": "Regain a point of Willpower any time you succeed at a dangerous task that you have deliberately undertaken.",
    "Traditionalist": "Regain a point of Willpower any time the proven ways turn out to be the best.",
    "Trickster": "Regain a point of Willpower any time you manage to lift others’ spirits, especially if you assuage your own pain.",
    "Visionary": "Regain a point of Willpower each time you are able to convince others to have faith in your dreams and follow your course of action."
};
...
export const CLAN_WEAKNESSES = {
    ...
    "Tremere": "Tremere dependency on blood is even more pronounced than that of other Kindred. It takes only two draughts of another vampire’s blood for a Tremere to become blood bound instead of the normal three — the first drink counts as if the Tremere had taken two drinks.",
    "Tzimisce": "The Tzimisce are inextricably tied to their domains of origin, and must rest in the proximity of at least two handfuls of “native soil” — earth from a place important to her as a mortal, such as the soil from her birthplace or the graveyard where she underwent her Embrace. Each night spent without this physical connection to her land limits all of the Tzimisce’s dice pools to one-half, cumulatively, until she has only a single die in her pool. The penalty remains until she rests for a full day amid her earth once more.",
