...
export const APP_VERSION = "v1.13 (V20 Specialties Fixed)";
...
// V20 Core Rulebook Official Specialty Examples (p. 96-109)
export const SPECIALTY_EXAMPLES = {
    // Attributes
    "Strength": ["Grip", "Heavy Lifting", "Jumping", "Pushing", "Throwing"],
    "Dexterity": ["Accuracy", "Agility", "Flexibility", "Grace", "Speed"],
    "Stamina": ["Determination", "Endurance", "Resilience", "Staying Power", "Toughness"],
    "Charisma": ["Eloquence", "Grace", "Inspiration", "Leadership", "Wit"],
    "Manipulation": ["Fast-Talking", "Guile", "Misdirection", "Persuasion", "Seduction"],
    "Appearance": ["Bold", "Dignified", "Exotic", "Honest", "Look of the Eagles"],
    "Perception": ["Attentive", "Insight", "Keen-Eyed", "Patient", "Unseen"],
    "Intelligence": ["Analytical", "Book Knowledge", "Creative", "Memory", "Probability"],
    "Wits": ["Ambushes", "Changes in Strategy", "Clever", "Get the Jump on Others", "Snappy Comebacks"],
    
    // Talents
    "Alertness": ["Ambushes", "Eavesdropping", "Hidden Weapons", "Noises", "Traps"],
    "Athletics": ["Climbing", "Jumping", "Parkour", "Swimming", "Throwing"],
    "Awareness": ["Auras", "Magic", "Spirits", "The Beast", "The Underworld"],
    "Brawl": ["Arm Locks", "Boxing", "Grappling", "Kicks", "Throws"],
    "Empathy": ["Emotions", "Lies", "Motives", "Personalities", "Spirits"],
    "Expression": ["Acting", "Dance", "Drama", "Poetry", "Singing"],
    "Intimidation": ["Physical Threats", "Social Pull", "Stare Down", "Veiled Threats", "Wit"],
    "Leadership": ["Command", "Inspiration", "Military", "Oratory", "Politics"],
    "Streetwise": ["Drugs", "Fencing", "Gangs", "Rumors", "Turf"],
    "Subterfuge": ["Impeccable Logic", "Lying", "Seduction", "Spotting Lies", "The Long Con"],
    
    // Skills
    "Animal Ken": ["Cats", "Dogs", "Farm Animals", "Horses", "Wild Animals"],
    "Crafts": ["Carpentry", "Electronics", "Mechanics", "Painting", "Sculpting"],
    "Drive": ["Curves", "Heavy Traffic", "High Speed", "Pursuit", "Stunts"],
    "Etiquette": ["Business", "High Society", "Kindred", "One-on-One", "Street"],
    "Firearms": ["Fast-Draw", "Pistols", "Rifles", "Shotguns", "Sniping"],
    "Larceny": ["Breaking and Entering", "Concealment", "Lockpicking", "Pickpocketing", "Safecracking"],
    "Melee": ["Axes", "Clubs", "Disarms", "Knives", "Swords"],
    "Performance": ["Acting", "Comedy", "Dance", "Instruments", "Singing"],
    "Stealth": ["Crowds", "Hiding", "Prowling", "Shadowing", "Silent Movement"],
    "Survival": ["Desert", "Jungle", "Tracking", "Urban", "Woodlands"],
    
    // Knowledges
    "Academics": ["History", "Law", "Linguistics", "Philosophy", "Theology"],
    "Computer": ["Data Retrieval", "Graphics", "Hacking", "Internet", "Programming"],
    "Finance": ["Appraisal", "Banking", "Corporate Finance", "Currency Manipulation", "Stock Market"],
    "Investigation": ["Artifacts", "Crime Scenes", "Forensics", "Research", "Search"],
    "Law": ["Corporate", "Criminal", "International", "Kindred Law", "Police Procedure"],
    "Medicine": ["Emergency Care", "Pathology", "Pharmaceuticals", "Poison", "Surgery"],
    "Occult": ["Cults", "Demonology", "Magic", "Vampires", "Werewolves"],
    "Politics": ["Bribery", "Camarilla", "City", "Dogma", "Radical"],
    "Science": ["Biology", "Chemistry", "Geology", "Mathematics", "Physics"],
    "Technology": ["Communications", "Computers", "Industrial", "Security", "Surveillance"]
};
